...
const AdminTopbar: React.FC<AdminTopbarProps> = ({ user }) => {
  ...
  return (
    <div className="fixed top-0 left-60 right-0 h-16 bg-white/90 backdrop-blur border-b border-gray-100 flex items-center px-6 z-10">
      {/* Mobile menu button */}
      ...
      <div className="flex-1 max-w-md">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 shadow-sm"
          />
        </div>
      </div>
